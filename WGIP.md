...
## Psuedocode for this: 
    ...
    *I took the liberty of rewriting the codebase from scratch [here](https://github.com/maxler0y/LLMBosted_WikipdiaGame/blob/main/tempScript) (although it does not work yet)*
